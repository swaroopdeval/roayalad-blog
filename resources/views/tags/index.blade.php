        ...
        <div class="card">
          ...
          <div class="row">
            <div class="col-12 text-right">
              <a href="{{ route('tags.create') }}" class="btn btn-sm btn-primary">Add Tags</a>
            </div>
          </div>
          <div class="col-sm-12">
                  ...
                  <tr>
                      ...
                      <td class="td-actions">
                            <form action="{{ route('tags.destroy', $tag->id) }}" method="post">
                                    ...
                                    <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('tags.edit', $tag->id) }}" data-original-title="" title="">
